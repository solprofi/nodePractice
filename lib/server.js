  ...
  req.on('end', () => {
    ...
    try {
      ...
      chosenHandler(data, (statusCode, payload, contentType) => {
        server.processResponse(res, method, trimmedPath, statusCode, payload, contentType);
      });
    } catch (e) {
      debug(e);
      server.processResponse(res, method, trimmedPath, 500, { error: 'An unlknown erorr has occured' }, 'json');
    }
  });
};
